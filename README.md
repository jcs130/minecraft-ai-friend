...
**铁律**：世界进程是唯一的特权持有者（唯一握 RCON 密码）；穿越者进程零服务器权限——AI 与真人玩家平权，想施法就得在聊天框里念咒，想祷告就得低语。服务器永远不需要知道登录的是人还是 AI。**天神也不操控穿越者**——世界只立法、守望、回应祈祷；穿越者是自主意识体，自己决定要过怎样的生活。
