...
await ctx.plugin(mcLogwatch, {
  ...
  logPath: 'C:/Users/lzl19/Documents/airi-minecraft/server/logs/latest.log',
  pollMs: 500,
})
...
await ctx.plugin(mcGod, {
  enabled: true,
  qwenpawUrl: 'http://127.0.0.1:8088/api/console/chat',
  cooldownMs: 60_000,
  pollMs: 12_000,
  ...
  advancementsDir: 'C:/Users/lzl19/Documents/airi-minecraft/server/advancements',
