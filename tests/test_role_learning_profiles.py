...
class RoleLearningProfiles(unittest.TestCase):
    ...
    def test_guard_requires_matching_live_entrypoint_and_process_start(self):
        ...
        marker = {'schema': 1, 'runtime': 'operations', 'guardVersion': 5, 'nativeToolGuardVersion': 1, 'llmPolicyVersion': 1, 'pid': 7, 'startedAt': 1002,
        ...
        with patch.object(contract.os, 'sysconf', return_value=100, create=True):
            ...
            for changes in ({'startedAt': 900}, {'startedAt': 1500}, {'guardVersion': 1}, {'runtime': 'game'}, {'pid': 8}):
