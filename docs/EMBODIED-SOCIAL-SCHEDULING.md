...
2026-09-21。状态：源码核查与设计，尚未实现本页新增机制。对应当前实现基线 `fdb35f3`；不把参考项目演示或论文实验当成本服验收。主要对照文件的固定版本与 SHA-256 见[阅读清单](research/embodied-social-scheduling-20260921.json)。
...
本次只形成方案与固定源码阅读清单，未运行外部机器人、调用模型、修改线上调度或部署运行代码；当前 Docker/磁盘故障须在实服验收前恢复，故障记录见 [上一轮研究](JEV-ASTRA-MINECRAFT-CODE-REVIEW.md)。
