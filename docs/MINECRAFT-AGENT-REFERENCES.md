...
2026-09-14 补充：[Prime Agent 长期自主成长研究](PRIME-AGENT-REFERENCE.md) 已核对固定官方源码，重点是可修订经验、持久目标、程序化上下文与实际结果验收。该补充是设计研究，未切换当前 QwenPaw/Numen 运行链路；下文保留9月8日的历史研究范围，调用政策以最新部署与用户要求为准。
