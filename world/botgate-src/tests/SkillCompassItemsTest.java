...
public class SkillCompassItemsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var cfg=new SkillChestLayout.Config();cfg.catalogAvailable=true;cfg.learningSnapshotAvailable=true;cfg.learned.add("home");
        ...
        var nativeItem=(ItemStack)icon.invoke(null,entries.get(6));
        ...
        var skill=(ItemStack)icon.invoke(null,entries.get(10));
        ...
        var archived=(ItemStack)icon.invoke(null,archive.get(10));
        ...
        var fallback=(ItemStack)icon.invoke(null,missing.get(10));
