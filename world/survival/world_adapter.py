...
class WorldAdapter(Protocol):
    ...
    def action(self, turn_id: str, tool: str, args: dict[str, Any], *, previous_request_id: str | None = None) -> dict[str, Any]: ...
    ...
    def navigation_observation(self, body: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]: ...
