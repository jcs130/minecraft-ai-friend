...
<style>
 :root{--bg:#0b0d11;--bar:#141821;--line:#242a36;--txt:#e8eaf0;--dim:#8c93a5;--acc:#6aa9ff;--ok:#3fbf7f}
 *{box-sizing:border-box}
 ...
 .dot.up{background:var(--ok)} .dot.down{background:#e5605e}
 h1{font-size:14px;margin:0;font-weight:600}
 .meta{color:var(--dim);font-size:12px}
 a{color:var(--acc);text-decoration:none;margin-left:auto;font-size:12px}
...
<div class="bar">
  ...
  <h1>天神之眼 · 世界观察</h1>
  <span class="meta" id="state">连接中…</span>
  <a href="http://127.0.0.1:19092/" target="_blank" rel="noopener">在新窗口打开 ↗</a>
</div>
<iframe id="eye" src="http://127.0.0.1:19092/" referrerpolicy="no-referrer"></iframe>
<div class="note">画面来自本机 <code>127.0.0.1:19092</code>（world 服务的 modern-viewer，Goddess 观察者视角，垂直 FOV 110°）。
若此处空白，用右上角在新窗口打开 —— 那说明对方不允许被嵌入，本体仍然正常。</div>
<script>
...
el.addEventListener('error', () => { dot.className = 'dot down'; state.textContent = '无法嵌入，请新窗口打开'; });
setTimeout(() => { if (!dot.className.includes('up')) { dot.className = 'dot down';
  state.textContent = '未在 2 秒内出画 —— 试试新窗口打开'; } }, 2000);
</script>
</body>
</html>
"""
