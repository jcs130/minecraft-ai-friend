...
目录可能含归档技能、原生主题映射和替代提示，以当前实服查询为准，不能用仓库候选推断已上线。归档不表示人物旧进度被删除；映射和替代提示都不是免费授予法术。遇到螺旋丸、星爆等旧名字先按需查 `help <技能ID>`，若映射铁魔法就检查对应原生装备、法力和冷却；不是相同的旧效果，也不额外消耗旧秘术魔力。获取卷轴后可在铭文台装入法术书并装备；手持卷轴直接施放会消耗卷轴。`help irons` 提供指引，`skills` 提供短索引，未确认结果只查询原回执，不重发。
