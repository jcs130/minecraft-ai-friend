 ...
 */
import { renderRequire } from './render-dependencies.mts'
const mineflayer = renderRequire('mineflayer')
const { Vec3 } = renderRequire('vec3')
const { Viewer } = renderRequire('prismarine-viewer/viewer/lib/viewer.js')
const { WorldView } = renderRequire('prismarine-viewer/viewer/lib/worldView.js')
const { getBufferFromStream } = renderRequire('prismarine-viewer/viewer/lib/simpleUtils.js')
const THREE = renderRequire('three')
const { createCanvas } = renderRequire('node-canvas-webgl/lib/index.js')
