...
Standing in the Nether, packlist intact → mark phase 2 `completed`, `read_skill("blaze_rods")`. Load `combat_basics` too if you haven't — blazes are the first real combat test.
